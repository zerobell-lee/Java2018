...
public class AppleClockPane extends ClockPane {
	...
	static private Stop[] skystops = new Stop[] {new Stop(0, Color.web("#48c6ef")), new Stop(1,  Color.web("#6f86d6"))};
	static private Stop[] nightskystops = new Stop[] {new Stop(0, Color.web("#1260d5")), new Stop(2,  Color.web("#d43f8d"))};
	static private LinearGradient sky = new LinearGradient(0,1,0,0, true, CycleMethod.NO_CYCLE, skystops);
	static private LinearGradient nightsky = new LinearGradient(0,0,0,1, true, CycleMethod.NO_CYCLE, nightskystops);
	...
	protected void paintClock() {
		...
		for (int i = 0; i < 12; i++) {
			...
			hourTick.setStroke(Color.WHITE);
